...
public class OptionValue implements Comparable<OptionValue> {
    ...
    @Nullable private final CardValue value2;
    @Nullable private final CardValue value3;
    @Nullable private final CardValue value4;
    @Nullable private final CardValue value5;
    private static final Map<HandName, Integer> reservedValues = new HashMap<>();
    static {
